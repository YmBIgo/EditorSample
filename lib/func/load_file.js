...
// Read Search Data
function readSearchResult(keyword, page_offset=1){
	// qwants api
	// var search_result = [];
	// qwant.search("web", {query: keyword, count: 10, offset: page_offset, language: "german"}, function(err, data){
	// 	if (err) { return [] };
	// 	search_result = data;
	// });
	...
	// 
	// url から 取得
	// https://api.qwant.com/api/search/web?count=10&offset=[page_count]&q=[keyword]&language=german&t=web&uiv=1
	// var qwant_url = "https://api.qwant.com/api/search/web?count=10&offset=" + page_offset + "&q=" + keyword + "&language=german&t=web&uiv=1"
	// var qwant_search_result =
	// fetch(qwant_url)
	// 	.then(res => res.json())
	// 	.then(body => { 
...
// Search Result
module.exports.search_qwant	  = readSearchResult;
// Generate file
