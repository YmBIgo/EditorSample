...
function analyze_css_file(file_content, file_path){
	...
	generate_file_json(css_return_hash, file_path);
...
function analyze_html_file(file_content, file_path){
	...
	html_return_hash[file_path]		= { "class" : class_result_hash, "id" : id_result_hash } ;
	generate_file_json(html_return_hash, file_path);
...
function analyze_js_file(file_content, file_path){
	...
	javascript_result_hash[file_path] = { "variable" : variable_result, "function" : defined_function_result, "class" : defined_class_result };
	generate_file_json(javascript_result_hash, file_path);
...
function generate_file_json(file_array, file_path){
	...
	file_path_for_gen	  = "./json_files/" + file_path_for_gen + ".json";
	try {
